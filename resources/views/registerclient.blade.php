            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="md:w-2/3 p-8">
                    <div class="text-center mb-8">
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create Client Account</h1>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Start your journey with us today</p>
                    </div>
                    ...
                    <form action="" method="POST">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <button type="button" 
                                                ...
                                                class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                            <svg id="eyeIconConfirm" class="h-5 w-5 text-gray-500 dark:text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                            </svg>
                                        </button>
                        ...
                        <!-- Error Messages -->
                        @if ($errors->any())
                        <div class="mt-6 bg-red-50 dark:bg-red-900/50 border-l-4 border-red-500 p-4">
                            <div class="flex">
